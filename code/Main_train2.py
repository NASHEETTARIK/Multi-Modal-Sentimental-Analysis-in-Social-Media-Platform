...
def Training() :
    ...
    root_dir = 'Augmented_Categorized_Videos'
    ...
    # np.save('Features/X_train_text_BAUM.npy', X_train_text)
    # np.save('Features/X_test_text_BAUM.npy', X_test_text)
    
    # # Save training and testing sets for audio
    # np.save('Features/X_train_audio_BAUM.npy', X_train_audio)
    # np.save('Features/X_test_audio_BAUM.npy', X_test_audio)
    
    # # Save training and testing sets for video1
    # np.save('Features/X_train_video1_BAUM.npy', X_train_video1)
    # np.save('Features/X_test_video1_BAUM.npy', X_test_video1)
    
    # # Save training and testing sets for video2
    # np.save('Features/X_train_video2_BAUM.npy', X_train_video2)
    # np.save('Features/X_test_video2_BAUM.npy', X_test_video2)
    
    # # Save training and testing sets for encoded data
    # np.save('Features/y_train_BAUM.npy', y_train)
    # np.save('Features/y_test_BAUM.npy', y_test)    
    
    
        
    X_train_text = np.load('Features/X_train_text_BAUM.npy')
    # Save training and testing sets for audio
    X_train_audio = np.load('Features/X_train_audio_BAUM.npy')
    # Save training and testing sets for video1
    X_train_video1 = np.load('Features/X_train_video1_BAUM.npy')
    # Save training and testing sets for video2
    X_train_video2 = np.load('Features/X_train_video2_BAUM.npy')
    
    y_train =np.load('Features/y_train_BAUM.npy')
